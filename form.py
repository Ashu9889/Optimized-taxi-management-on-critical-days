...
class login_system:
            def __init__(self,root):
                ...
                #for images.....................
                self.bg_icon=ImageTk.PhotoImage(file=r"C:/Users/Ashutosh/Bigdata/img_login.jpg")
                self.user_icon=PhotoImage(file=r"C:/Users/Ashutosh/Bigdata/man-user.png")
                self.pass_icon =PhotoImage(file=r"C:/Users/Ashutosh/Bigdata/password.png")
                self.logo_icon = PhotoImage(file=r"C:/Users/Ashutosh/Bigdata/logo.png")
                #variables for entry.............
                ...
                title = Label(Login_Frame, text="Login", font=("Industry Inc Detail Fill", 40, "bold"),bg="white", fg="gray", bd=0, relief=GROOVE)
                title.grid(row=0,columnspan=2)

                logo1lbl=Label(Login_Frame,image=self.logo_icon,bd=0).grid(row=1,columnspan=2,pady=20)
                labeluser=Label(Login_Frame,text="User ID",image=self.user_icon,compound=LEFT,font=("Industry Inc Detail Fill",20,"bold"),bg="white")
                ...
                pass_entry = Entry(Login_Frame, bd=5,textvariable=self.password,show="*", relief=GROOVE, font=("", 15)).grid(row=3, column=1, padx=20)
            ...
            def new2(self):
                ...
                ob1=Big.graph(self.newwin)

            def login(self):
                sql="SELECT * FROM LOGIN \
                     WHERE ID ='%s' AND PASSWORD ='%s'"%(self.username.get(),self.password.get())
                cursor.execute(sql)
